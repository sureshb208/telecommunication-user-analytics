...
def overview_app():
    ...
    top_3_df = pd.read_csv('data/top3_manu.csv')
    fig = px.bar(top_3_df, x='Unnamed: 0', y='Unnamed: 0', height=500)
    st.plotly_chart(fig)
    ...
    image = Image.open('assets/Top_Duration.png')
    ...
    image = Image.open('assets/Top_thoroughput.png')
